...
@WebServlet("/reviewGet2.do")
public class ReviewGet2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// view페이지로 이동
		request.getRequestDispatcher("/member_jsp/view/review_list.jsp").forward(request, response);
	}
