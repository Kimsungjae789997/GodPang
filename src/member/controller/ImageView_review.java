...
@WebServlet("/imageView_review.do")
public class ImageView_review extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String prod_img = service.getReviewImg(prod_id);
		...
		File imgFile = new File(f, prod_img);
