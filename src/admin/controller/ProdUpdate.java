...
public class ProdUpdate extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String prod_name = request.getParameter("prod_name1");
		String prod_content = request.getParameter("prod_content1");
		int prod_cost = Integer.parseInt(request.getParameter("prod_cost1"));
		int prod_price = Integer.parseInt(request.getParameter("prod_price1"));
		String lprod_gu = request.getParameter("lprod_gu1");
		...
		String uploadPath = request.getServletContext().getRealPath("/images/prod");
		...
		Part part = request.getPart("prod_img1");
