...
@WebServlet("/prodStockGet.do")
public class ProdStockGet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PageVO vo = service.getPageInfo3(page, stype, sword);
		...
		List<ProdStockVO> list = service.selectByPage3(map);
		...
		// view페이지로 이동
		request.getRequestDispatcher("/admin_jsp/admin_prod/view/admin_list.jsp").forward(request, response);
