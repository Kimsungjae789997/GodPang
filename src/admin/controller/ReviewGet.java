...
@WebServlet("/reviewGet.do")
public class ReviewGet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PageVO vo = service.getPageInfo4(page, stype, sword);
		...
		List<ReviewVO> list = service.selectByPage4(map);
		...
		// view페이지로 이동
		request.getRequestDispatcher("/admin_jsp/admin_review/view/admin_list.jsp").forward(request, response);
	}
