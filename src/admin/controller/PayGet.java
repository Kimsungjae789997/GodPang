...
@WebServlet("/payGet.do")
public class PayGet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PageVO vo = service.getPageInfo2(page, stype, sword);
		...
		List<PayVO> list = service.selectByPage2(map);
		...
		// view페이지로 이동
		request.getRequestDispatcher("/admin_jsp/admin_reply/view/admin_list.jsp").forward(request, response);
	}
