...
$(function(){
	...
	$(document).on('click','#paymethodinsert',function(){
...
<body>
	...
	<div class="sports_div_class1">
		...
		<div class="sports_div_class2">
			...
			<br><br>
			<div style="display: flex; flex-direction: column; align-items: center; border: 1px solid gray; background-color:#F6F6F6; ">
			    <img width="200px" height="150px;" src="<%=request.getContextPath()%>/images/login/wow이미지.jpg">
				<p style="font-size: 25pt; font-weight: bold; ">슈프림 멤버십</p>
				<span style="border-top: 1px solid #aaa; border-bottom: 1px solid #aaa;">
				<p style="font-size: 20pt;">월 4990원으로 혜택을 이어가세요~</p>
				</span>
				<br><br>
				<button id="membershipInsert" style="background-color: #4374D9; 
				color: white; width: 130pt; height: 50pt; font-weight: bold; font-size: 12pt;">와우 멤버십 신청하기</button>
			<br><br>
			</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body"><br><br><br><br>
        <p style="font-weight: bold; font-size:15pt; text-align: center;">-등록한 결제수단 방법이 없습니다.-</p>  <!-- 결제수단 등록하면 여기에 셀렉트해준다.  이 결제수단 선택x =>수정으로 한다.        -->
        	...
        	<br><br><br><br><br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <button id="paymethodinsert" type="button" class="btn btn-danger" data-bs-dismiss="modal" style="width: 300pt; background-color: white; border: 3px solid skyblue; color: #5CD1E5; font-weight: bold;">결제수단 등록</button>
      </div>
...
<div class="modal" id="bank_insert">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal Header -->
      <div class="modal-header">
        <h4 class="modal-title" style="font-weight: bold;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;은행 계좌 등록</h4>
 ...
 <div class="container mt-3">
  <h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;본인 계좌 확인</h2>
  <form action="<%=request.getContextPath()%>/mypageBankInsert.do" method="post">
    <div class="mb-3 mt-3">
    ...
    <button type="submit" id="registerBtn" disabled class="btn btn-primary" style="width: 100%; font-weight:bold; color: black; background-color:#EAEAEA; border-color: white; ">등록하기</button>
  </form>
</div>
        <!--  -->	
