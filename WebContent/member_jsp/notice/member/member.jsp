...
$(() => {
    ...
    $('#send').on('click',function(){
        ...
        $.ajax({
            url : "/ShopEcommerce/UpdateMember.do",
            type : 'post',
            data : fdata3,
            success : result => {
                if(result.flag == "성공"){
...
<div class="container mt-3">
    ...
    <form id="ff">
        ...
        <div class="mb-3 mt-3">
            ...
            <input type="text" class="form-control" id="hp" name="mem_tel">
        </div>
        <div class="mb-3 mt-3">
        ...
        <div class="mb-3 mt-3">
            ...
            <input type="text" class="form-control addr" id="add1" name="mem_add1">
        </div>
        <div class="mb-3 mt-3">
            <label for="add2">상세주소</label>
            <input type="text" class="form-control addr" id="add2" name="mem_add2">
        </div>
