...
$.listPage = function(){
    ...
    $.ajax({
        url : '<%=request.getContextPath()%>/prodStockGet.do',
        data : {
            "page" : currentPage,
            "stype"  :  vstype,
            "sword"  :  vsword
            ...
            $.each(result.datas, function(i,v){
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td class="prod_stock_j_00">${v.prod_stock_j_00}</td>
                        <td class="prod_stock_in">${v.prod_stock_in}</td> 
                        <td class="prod_stock_j_99">${v.prod_stock_j_99}</td>
                        <td class="prod_stock_date">${v.prod_stock_date}</td>
                    </tr>
                </table>
                </div>
 ...
 // 등록 ==========================================================================================================================
    ...
    $(document).on('click', 'input[name="checkbox"]', function() {
      ...
      $('#delete').on('click', function(){
          ...
          // 선택된 ID 목록을 서버로 보내 삭제 작업 수행
          $.ajax({
              url: '<%=request.getContextPath()%>/prodstockDelete.do',
              type: 'post',
...
<div class="container mt-5">
  <div class="row">
     <div class="col-sm-4" style="width: 100%; text-align: center;">
      <h1 style="font-weight: bold; ">상품재고 현황</h1>
      <br><br><br>
      <h3>현재 시간</h3>
   ...
   <div class="col-sm-8" style="width: 100%;">
               ...
               <select class="form-select" id="stype">
                  ...
                  <option value="prod_stock_date">변경일자</option>
...
<div class="modal" id="insertModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">상품재고 관리</h4>
  ...
  <form action="<%=request.getContextPath()%>/prodstockInsert.do" method="post">
  <div class="mb-3 mt-3">
  ...
  <div class="mb-3">
    <label for="prod_stock_j_00" class="form-label">상품기초재고수량:</label>
    <input type="text" class="form-control" id="prod_stock_j_00" placeholder="Enter prod_stock_j_00" name="prod_stock_j_00">
  </div>
    <div class="mb-3">
    <label for="prod_stock_in" class="form-label">상품입고수량합계:</label>
    <input type="text" class="form-control" id="prod_stock_in" placeholder="Enter prod_stock_in" name="prod_stock_in">
  </div>
    <div class="mb-3">
    <label for="prod_stock_j_99" class="form-label">상품현재고:</label>
    <input type="text" class="form-control" id="prod_stock_j_99" placeholder="Enter prod_stock_j_99" name="prod_stock_j_99">
  </div>
...
<div class="modal" id="updateModal">
  ...
  <form action="<%=request.getContextPath()%>/prodstockUpdate.do" method="post">
  <div class="mb-3 mt-3">
    <label for="prod_id" class="form-label">상품코드:</label>
    <input type="text" class="form-control" id="prod_id1" placeholder="Enter prod_id" name="prod_id1" readonly>
  </div>
  <div class="mb-3">
    <label for="prod_stock_j_00" class="form-label">상품기초재고수량:</label>
    <input type="text" class="form-control" id="prod_stock_j_00" placeholder="Enter prod_stock_j_00" name="prod_stock_j_00">
