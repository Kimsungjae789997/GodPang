...
$.listPage = function(){
    ...
    $.ajax({
        url : '<%=request.getContextPath()%>/reviewGet.do',
        data : {
            "page" : currentPage,
            "stype"  :  vstype,
            "sword"  :  vsword
            ...
            $.each(result.datas, function(i,v){
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td class="review_no">${v.review_no}</td> 
                        <td class="review_title">${v.review_title}</td>
                        <td class="review_content">${v.review_content}</td> 
                        <td class="review_write_date">${v.review_write_date}</td>
...
$(function(){
    ...
    $('#delete').on('click', function(){
        ...
        $('input[name="checkbox"]:checked').each(function() {
            var id = $(this).closest('tr').find('.review_no').text();
            checkedIds.push(id);
        });
        ...
        $.ajax({
            url: '<%=request.getContextPath()%>/reviewDelete.do',
            type: 'post',
...
<div class="container mt-5">
  <div class="row">
    <div class="col-sm-4" style="width: 100%; text-align: center;">
      <h1 style="font-weight: bold; ">리뷰 관리 현황</h1>
      <br><br><br>
      <h3>현재 시간</h3>
    ...
    <div class="col-sm-8" style="width: 100%;">
	         <form class="d-flex">
               <select class="form-select" id="stype">
                  ...
                  <option value="review_title">리뷰 제목</option>
