...
<script src="../lfie/lfie.js"></script>
...
<script type="text/javascript">
	...
	var mypath = "<%=request.getContextPath()%>";
		...
		$('#ranklfieProd').on('click', function(){
			...
			$.ajax({
				...
				success: function(res){
					...
					$.each(res, function(i,v){
						rcode += `<dl class="lfie_d1">
										<div class="prod_detail_id" style="display:none">${v.prod_id}</div>
										<dt class="lfie_dt1">
											<img src="../../images/prod/P006/${v.prod_img}" width="300" height="300" alt="${v.prod_name}">
										</dt>
										<dd class="lfie_dd1">
											<div class="lfie_div">
		...
		$('#highlfieProd').on('click', function(){
...
<body>
	<div id="containor" class="total_div">
		...
		<div class="lfie_div_class1">
			<div class="lfie_div_class2">
				<h2 class="lfie_h3">생활용품</h2>
				<div class="lfie_div_class3">
					<div class="lfie_div_lfie4">
						<div id="lfie_id_div1">
							<ul class="lfie_ul">
								<li class="lfie_selected"><input type="radio"
									id=ranklfieProd name="lfie" value="P006"> <label>갓팡랭킹순</label>
								</li>

								<li class="lfie_selected"><input type="radio"
									id=lowlfieProd name="lfie" value="P006"> <label>낮은가격순</label>
								</li>

								<li class="lfie_selected"><input type="radio"
									id=highlfieProd name="lfie" value="P006"> <label>높은가격순</label>
								</li>
							</ul>
						</div>
					</div>
			...
			<!-- 여기 위는 '스포츠/레저' -->
			<!-- 여기 아래는 상품 리스트 -->
			<div id="lfie_prod_list">
				<section>
					<ul id="lfie_list">
						<!-- = <li class="baby-product" -->
						<li class="lfie_prod1"><a class="lfie_a1" href="#"></a></li>

						<li class="lfie_prod2"><a class="lfie_a2" href="#"></a></li>
