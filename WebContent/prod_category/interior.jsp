...
<script src="../interior/interior.js"></script>
...
<script type="text/javascript">
	...
	var mypath = "<%=request.getContextPath()%>";
		...
		// 상품 카테고리별 상품 조회(ex) 카테고리 ->> 홈인테리어 누르면 젤 처음 출력되는 화면 = "갓팡랭킹순"
		$('#rankinteriorProd').on('click', function(){
			...
			$.ajax({
				...
				success: function(res){
					...
					$.each(res, function(i,v){
						rcode += `<dl class="interior_d1">
										<div class="prod_detail_id" style="display:none">${v.prod_id}</div>
										<dt class="interior_dt1">
											<img src="../../images/prod/P007/${v.prod_img}" width="300" height="300" alt="${v.prod_name}">
										</dt>
										<dd class="interior_dd1">
		...
		// 홈인테리어 카테고리 상품 낮은 가격순 출력
		$('#lowinteriorProd').on('click', function(){
		...
		// 홈인테리어 카테고리 상품 높은 가격순 출력
		$('#highinteriorProd').on('click', function(){
...
<body>
	<div id="containor" class="total_div">
		...
		<div class="interior_div_class1">
			<div class="interior_div_class2">
				<h2 class="interior_h3">홈인테리어</h2>
				<div class="interior_div_class3">
					<div class="interior_div_interior4">
						<div id="interior_id_div1">
							<ul class="interior_ul">
								<li class="interior_selected"><input type="radio"
									id=rankinteriorProd name="interior" value="P007"> <label>갓팡랭킹순</label>
								</li>

								<li class="interior_selected"><input type="radio"
									id=lowinteriorProd name="interior" value="P007"> <label>낮은가격순</label>
								</li>

								<li class="interior_selected"><input type="radio"
									id=highinteriorProd name="interior" value="P007"> <label>높은가격순</label>
								</li>
							</ul>
						</div>
					</div>
			...
			<!-- 여기 위는 '스포츠/레저' -->
			<!-- 여기 아래는 상품 리스트 -->
			<div id="interior_prod_list">
				<section>
					<ul id="interior_list">
						<!-- = <li class="baby-product" -->
						<li class="interior_prod1"><a class="interior_a1" href="#"></a></li>

						<li class="interior_prod2"><a class="interior_a2" href="#"></a></li>
