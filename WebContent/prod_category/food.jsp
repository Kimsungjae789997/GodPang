...
<script type="text/javascript">
	...
	var mypath = "<%=request.getContextPath()%>";
		...
		// 상품 카테고리별 상품 조회(ex) 카테고리 ->> 식품 누르면 젤 처음 출력되는 화면 = "갓팡랭킹순"
		$('#rankfoodProd').on('click', function(){
			...
			$.ajax({
				...
				success: function(res){
					...
					$.each(res, function(i,v){
						rcode += `<dl class="food_d1">
										<div class="prod_detail_id" style="display:none">${v.prod_id}</div>
										<dt class="food_dt1">
											<img src="../../images/prod/P004/${v.prod_img}" width="300" height="300" alt="${v.prod_name}">
										</dt>
										<dd class="food_dd1">
											<div class="food_div">
		...
		// 식품 카테고리 상품 낮은 가격순 출력
		$('#lowfoodProd').on('click', function(){
		...
		// 식품 카테고리 상품 높은 가격순 출력
		$('#highfoodProd').on('click', function(){
...
<body>
	<div id="containor" class="total_div">
		...
		<div class="food_div_class1">
			<div class="food_div_class2">
				<h2 class="food_h3">식품</h2>
				<div class="food_div_class3">
					<div class="food_div_food4">
						<div id="food_id_div1">
							<ul class="food_ul">
								<li class="food_selected"><input type="radio"
									id=rankfoodProd name="food" value="P004"> <label>갓팡랭킹순</label>
								</li>

								<li class="food_selected"><input type="radio"
									id=lowfoodProd name="food" value="P004"> <label>낮은가격순</label>
								</li>

								<li class="food_selected"><input type="radio"
									id=highfoodProd name="food" value="P004"> <label>높은가격순</label>
								</li>
							</ul>
						</div>
					</div>
			...
			<!-- 여기 위는 '스포츠/레저' -->
			<!-- 여기 아래는 상품 리스트 -->
			<div id="food_prod_list">
				<section>
					<ul id="food_list">
						<!-- = <li class="baby-product" -->
						<li class="food_prod1"><a class="food_a1" href="#"></a></li>

						<li class="food_prod2"><a class="food_a2" href="#"></a></li>
