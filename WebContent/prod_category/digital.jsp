...
<script src="../digital/digital.js"></script>
...
<script type="text/javascript">
	...
	var mypath = "<%=request.getContextPath()%>";
		...
		// 상품 카테고리별 상품 조회(ex) 카테고리 ->> 가전디지털 누르면 젤 처음 출력되는 화면 = "갓팡랭킹순"
		$('#rankdigitalProd').on('click', function(){
			...
			$.ajax({
				...
				success: function(res){
					...
					$.each(res, function(i,v){
						rcode += `<dl class="digital_d1">
										<div class="prod_detail_id" style="display:none">${v.prod_id}</div>
										<dt class="digital_dt1">
											<img src="../../images/prod/P008/${v.prod_img}" width="300" height="300" alt="${v.prod_name}">
										</dt>
										<dd class="digital_dd1">
		...
		// 가전디지털 카테고리 상품 낮은 가격순 출력
		$('#lowdigitalProd').on('click', function(){
		...
		// 가전디지털 카테고리 상품 높은 가격순 출력
		$('#highdigitalProd').on('click', function(){
...
<body>
	<div id="containor" class="total_div">
		...
		<div class="digital_div_class1">
			<div class="digital_div_class2">
				<h2 class="digital_h3">가전디지털</h2>
				<div class="digital_div_class3">
					<div class="digital_div_digital4">
						<div id="digital_id_div1">
							<ul class="digital_ul">
								<li class="digital_selected"><input type="radio"
									id=rankdigitalProd name="digital" value="P008"> <label>갓팡랭킹순</label>
								</li>

								<li class="digital_selected"><input type="radio"
									id=lowdigitalProd name="digital" value="P008"> <label>낮은가격순</label>
								</li>

								<li class="digital_selected"><input type="radio"
									id=highdigitalProd name="digital" value="P008"> <label>높은가격순</label>
								</li>
							</ul>
						</div>
					</div>
			...
			<!-- 여기 위는 '스포츠/레저' -->
			<!-- 여기 아래는 상품 리스트 -->
			<div id="digital_prod_list">
				<section>
					<ul id="digital_list">
						<!-- = <li class="baby-product" -->
						<li class="digital_prod1"><a class="digital_a1" href="#"></a></li>

						<li class="digital_prod2"><a class="digital_a2" href="#"></a></li>
