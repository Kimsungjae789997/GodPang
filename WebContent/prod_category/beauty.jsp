...
<script src="../beauty/beauty.js"></script>
...
<script type="text/javascript">
	...
	var mypath = "<%=request.getContextPath()%>";
		...
		// 상품 카테고리별 상품 조회(ex) 카테고리 ->> 뷰티 누르면 젤 처음 출력되는 화면 = "갓팡랭킹순"
		$('#rankbeautyProd').on('click', function(){
			...
			$.ajax({
				...
				success: function(res){
					...
					$.each(res, function(i,v){
						rcode += `<dl class="beauty_d1">
										<div class="prod_detail_id" style="display:none">${v.prod_id}</div>
										<dt class="beauty_dt1">
											<img src="../../images/prod/P002/${v.prod_img}" width="300" height="300" alt="${v.prod_name}">
										</dt>
										<dd class="beauty_dd1">
											<div class="beauty_div">
		...
		// 뷰티 카테고리 상품 낮은 가격순 출력
		$('#lowbeautyProd').on('click', function(){
		...
		// 뷰티 카테고리 상품 높은 가격순 출력
		$('#highbeautyProd').on('click', function(){
...
<body>
	<div id="containor" class="total_div">
		...
		<div class="beauty_div_class1">
			<div class="beauty_div_class2">
				<h2 class="beauty_h3">뷰티</h2>
				<div class="beauty_div_class3">
					<div class="beauty_div_beauty4">
						<div id="beauty_id_div1">
							<ul class="beauty_ul">
								<li class="beauty_selected"><input type="radio"
									id=rankbeautyProd name="beauty" value="P002"> <label>갓팡랭킹순</label>
								</li>

								<li class="beauty_selected"><input type="radio"
									id=lowbeautyProd name="beauty" value="P002"> <label>낮은가격순</label>
								</li>

								<li class="beauty_selected"><input type="radio"
									id=highbeautyProd name="beauty" value="P002"> <label>높은가격순</label>
								</li>
							</ul>
						</div>
					</div>
			...
			<!-- 여기 위는 '스포츠/레저' -->
			<!-- 여기 아래는 상품 리스트 -->
			<div id="beauty_prod_list">
				<section>
					<ul id="beauty_list">
						<!-- = <li class="baby-product" -->
						<li class="beauty_prod1"><a class="beauty_a1" href="#"></a></li>

						<li class="beauty_prod2"><a class="beauty_a2" href="#"></a></li>
