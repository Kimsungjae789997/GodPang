...
<script src="../fashion/fashion.js"></script>
...
<script type="text/javascript">
	...
	var mypath = "<%=request.getContextPath()%>";
		...
		// 상품 카테고리별 상품 조회(ex) 카테고리 ->> 패션 누르면 젤 처음 출력되는 화면 = "갓팡랭킹순"
		$('#rankfashionProd').on('click', function(){
			...
			$.ajax({
				...
				success: function(res){
					...
					$.each(res, function(i,v){
						rcode += `<dl class="fashion_d1">
										<div class="prod_detail_id" style="display:none">${v.prod_id}</div>
										<dt class="fashion_dt1">
											<img src="../../images/prod/P001/${v.prod_img}" width="300" height="300" alt="${v.prod_name}">
										</dt>
										<dd class="fashion_dd1">
											<div class="fashion_div">
		...
		// 패션 카테고리 상품 낮은 가격순 출력
		$('#lowfashionProd').on('click', function(){
		...
		// 패션 카테고리 상품 높은 가격순 출력
		$('#highfashionProd').on('click', function(){
...
<body>
	<div id="containor" class="total_div">
		...
		<div class="fashion_div_class1">
			<div class="fashion_div_class2">
				<h2 class="fashion_h3">패션의류/잡화</h2>
				<div class="fashion_div_class3">
					<div class="fashion_div_fashion4">
						<div id="fashion_id_div1">
							<ul class="fashion_ul">
								<li class="fashion_selected"><input type="radio"
									id=rankfashionProd name="fashion" value="P001"> <label>갓팡랭킹순</label>
								</li>

								<li class="fashion_selected"><input type="radio"
									id=lowfashionProd name="fashion" value="P001"> <label>낮은가격순</label>
								</li>

								<li class="fashion_selected"><input type="radio"
									id=highfashionProd name="fashion" value="P001"> <label>높은가격순</label>
								</li>
							</ul>
						</div>
					</div>
			...
			<!-- 여기 위는 '스포츠/레저' -->
			<!-- 여기 아래는 상품 리스트 -->
			<div id="fashion_prod_list">
				<section>
					<ul id="fashion_list">
						<!-- = <li class="baby-product" -->
						<li class="fashion_prod1"><a class="fashion_a1" href="#"></a></li>

						<li class="fashion_prod2"><a class="fashion_a2" href="#"></a></li>
